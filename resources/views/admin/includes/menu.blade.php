...
<li {{ (Request::is('admin/cert/management') ? 'class=active' : '') }}>
    <a href="{{ route('admin-cert-index') }}"><i class="fa fa-openid" aria-hidden="true"></i> &nbsp&nbsp List Certification</a>
</li>

<li {{ (Request::is('admin/cert/requests') ? 'class=active' : '') }}>
    <a href="{{ route('admin-request-index') }}"><i class="fa fa-openid" aria-hidden="true"></i> &nbsp&nbsp List Certification Requests</a>
</li>
<!-- giáp: hết -->
