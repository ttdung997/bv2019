...
class ApiManagement {
    ...
    public function ApiResult($sensor) {
        $data = [];
            $curl = curl_init();
            curl_setopt_array($curl, array(
                CURLOPT_PORT => PORT,
                ...
                CURLOPT_URL => HOST . ":" . PORT
                . "/~/mn-cse/mn-name/SOICT?op=sensor_data&ipaddr=192.168.0.110&macaddr=null&room=null&department=null&port=20000&data=".$sensor,
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => "",
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 120,
