...
//route cho module chung thuc so
// AdminController

Route::group(['prefix' => 'admin', 'middleware' => 'admin'], function() {
    Route::get('cert/init', 'AdmincertController@init')->name('admin-cert-init');

    Route::get('cert/management/index', 'CertificateController@index')->name('admin-cert-index');
    Route::get('cert/management/show/{id}', 'CertificateController@adminShowCert')->name('admin-cert-show');


    Route::get('cert/request/index', 'AdmincertController@index')->name('admin-request-index');
    Route::get('cert/request/edit/{id}', 'AdmincertController@edit')->name('admin-request-edit');
    Route::put('cert/request/update/{id}', 'AdmincertController@update')->name('admin-request-update');


    Route::get('cert/intro-request/edit/{id}', 'IntroductionController@edit')->name('admin-intro-request-edit');
     Route::put('cert/intro-request/update/{id}', 'IntroductionController@update')->name('admin-intro-request-update');


   
    Route::post('certificate-revoke/{numberRequest}/{certificate}', 'RevokeController@certificateUpdate')->name('revoke.update');
    Route::get('certificate-update-status', 'AdminController@certificateStatus')->name('update.status');
});

Route::group(['prefix' => 'certificate'], function() {
  
    Route::get('register-request/index', 'RegisterRequestController@index')->name('register-request-index');
    Route::get('register-request/create', 'RegisterRequestController@create')->name('register-request-create');
    Route::post('register-request/store', 'RegisterRequestController@store')->name('register-requests-store');
    Route::get('register-request/show', 'RegisterRequestController@destroy')->name('register-requests-show');
    Route::get('check', 'CertificateController@check')->name('check');


    Route::get('intro-requests/index', 'IntroductionController@index')->name('intro-requests-index');
    Route::get('intro-requests/create', 'IntroductionController@create')->name('intro-requests-create');
    Route::post('intro-requests/store', 'IntroductionController@store')->name('intro-requests-store');
    

    Route::get('create', 'CertificateController@createCert')->name('createCert');
    Route::post('store', 'CertificateController@storeCert')->name('storeCert');
    Route::get('show', 'CertificateController@showCert')->name('showCert');

    Route::get('download-pkcs12/{certificate}', 'CertificateController@download')->name('download-pkcs12');
    Route::get('download-pkcs12/{certificate}', 'CertificateController@download')->name('download-pkcs12');
    Route::get('download-cert/{certificate}', 'CertificateController@download')->name('download-cert');
    Route::get('download-pkcs12/{certificate}', 'CertificateController@download')->name('download-pkcs12');
    Route::post('check-cert', 'CertificateController@checkCert')->name('check-cert');

    
    // Route::get('notifications', 'CertificateController@notifications')->name('notifications');
    // Route::get('marks', 'CertificateController@markAsAll')->name('marks');
});
